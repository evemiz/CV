        ...
        <div className="container-fluid">
            ...
            <div className="row justify-content-center templates-grid-container">
                <div onClick={(e) => setTemplateToShow(1)} className="col-auto">
                    <img className="img-templates" style={{height: '350px'}} src={`public/examples/${i18n.language === 'he' ? 'heb' : 'eng'}1.png`}></img>
                </div>
                <div onClick={(e) => setTemplateToShow(2)} className="col-auto">
                    <img className="img-templates" style={{height: '350px'}} src={`public/examples/${i18n.language === 'he' ? 'heb' : 'eng'}2.png`}></img>
                </div>
